...
export default defineComponent({
  setup() {
    ...
    function scenceFun() {
      scence.name = "场景"; //场景名字
      camera.name = "相机"; //相机名字
      camera.position.set(100, 100, 1000); //相机位置
    ...
    function xAxisFun() {
      xAxis = new AxesHelper(600); //长度29的坐标轴
    ...
    function pointsFun() {
      console.log(MathUtils.randFloatSpread(100));
